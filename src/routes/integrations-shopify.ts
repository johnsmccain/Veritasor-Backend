 ...
 */
integrationsShopifyRouter.post('/connect', (req: Request, res: Response) => {
  ...
  try {
    const { redirectUrl } = startConnect(shop)
 ...
 * Exchanges code for access token and stores it; redirects to success URL or returns JSON error.
 */
